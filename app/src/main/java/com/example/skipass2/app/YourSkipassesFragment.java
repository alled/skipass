 ...
 */
public class YourSkipassesFragment extends ListFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View contentView = inflater.inflate(R.layout.fragment_skipasses, container, false);
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        Fragment fragment = new YourSkipassFragment();
